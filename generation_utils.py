...
class GenerationMixin:
    ...
    def _prepare_encoder_decoder_kwargs_for_generation(
        self, input_ids: torch.LongTensor, attention_mask: torch.BoolTensor, seq_num, model_kwargs
    ) -> Dict[str, Any]:
        if "encoder_outputs" not in model_kwargs:
            ...
            ModelOutput["last_hidden_state"] = encoder_hidden_states
            # print(ModelOutput)
            # ModelOutput.last_hidden_state = encoder_hidden_states
    ...
    def generate(
        ...
        **model_kwargs,
        ...
        if self.config.is_encoder_decoder:
            ...
            model_kwargs = self._prepare_encoder_decoder_kwargs_for_generation(input_ids, attention_mask, seq_num, model_kwargs)
